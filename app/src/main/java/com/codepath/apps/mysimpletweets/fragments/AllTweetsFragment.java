 ...
 */
public class AllTweetsFragment extends TweetsListFragment {
    public TwitterClient client;
    private boolean popular;
    private String query;

    public static AllTweetsFragment newInstance(int page, String query) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        args.putString("query", query);
        AllTweetsFragment fragment = new AllTweetsFragment();
